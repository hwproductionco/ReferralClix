var App = function () {
    ...
    var handleDashboardCharts = function () {
        ...
        var plot = $.plot($("#site_statistics"), [{
            ...
            xaxis: {
                ticks: [11, [Math.PI / 2, "Week of 3/18"],
                        [Math.PI, "Week of 3/25"],
                        [Math.PI * 3 / 2, "3\u03c0/2"],
                        [Math.PI * 2, "2\u03c0"],
						[Math.PI * 2, "2\u03c0"],
						[Math.PI * 2, "2\u03c0"]
  ...
  //Basic Chart
    ...
    var handleGritterAlerts = function () {
        if (!jQuery.gritter) {
            return;
        }
    ...
    return {
        ...
        init: function () {
            ...
            handleGritterAlerts(); // handles gritter Alerts
