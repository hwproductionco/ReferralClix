...
if ($_SERVER['REQUEST_METHOD']=='POST')
	...
	if ($step=='get_contacts')
		...
		if (empty($_POST['email_box']))
			$ers['email']="Email Inactive !";
		if (empty($_POST['password_box']))
			$ers['password']="Password Inactive !";
		if (empty($_POST['provider_box']))
			$ers['provider']="Provider Inactive !";
		if (count($ers)==0)
			{
...
$contents.="<center><a href='http://openinviter.com/'><img src='http://openinviter.com/images/banners/banner_blue_1.gif?nr=81047' border='0' alt='Powered by OpenInviter.com' title='Powered by OpenInviter.com'></a></center>";
if (!$done)
	{
