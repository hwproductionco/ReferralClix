      ...
      <tr>
    	<td style="font-size: 12px;">
               <table width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#FFFFFF">
                ...
                <span style="color: #484848; font-size: 23px; font-weight: 800; font-family: Tahoma, Arial, sans-serif;"><?=$uname;?></span>
                ...
                <center>              
            	<a href="<?=$url;?>">
                <img alt="Buy Now" border="0" src="http://www.sfx-resorts.com/emails/images/buy_button.png">
                </a></center>
                ...
                <tbody>
                <tr>
                <td valign="bottom" width="600" colspan="3" style="font-family: Tahoma, Geneva, sans-serif; font-size: 12px; padding-top: 25px; padding-bottom: 30px;"><span style="font-size: 15px; font-weight: bold;"> Hi <?=$name[0];?>,</span><br />
                <br />
                Your friend <?=$uname;?> shared this because we both think that you could use a vacation! We want to share our excitement for a new travel company that saves you and your family thousands of dollars on accommodations around the world as well as provides discounts on things you use every day on vacation and at home.<br />
                <br />
                <br /></td>
                </tr>
                <tr>
                ...
                <tr>
                <td valign="middle" height="90" align="center" style="color: #403f3f; font-size: 12px; font-weight: 400; font-family: Tahoma, Arial, sans-serif;" colspan="6">&copy;2012-2013 Owner Referrals. All Rights Reserved.</td>
                </tr>
                </tbody>
                </table>
                </td>
