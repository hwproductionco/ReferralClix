        ...
        <div class="container wrapper">
            <div class="row">
                ...
                <div class="span12 content">
					...
					<div class="well">
                    	<h4>Thank You for filling out our site survey!</h4><p>You will be receiving an email shortly verifying your interest in qualifying for an amazing escape courtesy of "<?=VENDOR_NAME;?>" as well as your 16 digit activation code for your membership.  Someone will be contacting you in the next 48 hours to speak with you regarding your getaway.<br><br>Cheers:<br>
<?=RESORT_NAME;?></p>
<hr>
<?php if($_GET['fb']==1): ?><center><a href="http://www.facebook.com">Go back to Facebook</a><?php else: ?><center><a href="index.php">Go back to homepage</a><?php endif; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="#">Visit Tour-No-Buy</a></center>
                    </div>
